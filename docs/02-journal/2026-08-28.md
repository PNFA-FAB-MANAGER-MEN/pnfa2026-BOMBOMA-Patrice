...
![photo Carte découpée](images/Laser15.jpg)

### Atelier électronique

- Programmé un code permettant d'allumer d-es LED en fonction de la luminosité ambiante en utilisant un capteur photosensible
...
![image slice](images/Impr3D10.png)
